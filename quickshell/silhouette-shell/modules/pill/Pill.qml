...
Item {
     ...
     * by PillOverlay (the pill sits inside a soft-edged mask slot there). Once
     * the last card is flung the pill sits behind the mask at zero opacity; it
     * snaps home unseen and only the fade animates back.
     */
