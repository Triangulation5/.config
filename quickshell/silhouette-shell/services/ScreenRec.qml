 ...
 * `$XDG_CACHE_HOME/silhouette/rec-thumbs`, skipping clips already cached) and only
...
Singleton {
    ...
    readonly property string thumbDir: (Quickshell.env("XDG_CACHE_HOME") || (home + "/.cache")) + "/silhouette/rec-thumbs/"
