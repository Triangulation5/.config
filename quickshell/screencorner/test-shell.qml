...
PanelWindow {
    ...
    Item {
        ...
        Rectangle {
            ...
            color: Qt.rgba(Theme.capsule.r, Theme.capsule.g, Theme.capsule.b, 1.0)
            ...
            Column {
                ...
                opacity: corners.morphProgress > 0.2 ? corners.morphProgress : 0
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        color: Qt.lighter(Theme.capsule, 1.08)
